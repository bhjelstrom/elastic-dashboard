(() => {
    var P = () => navigator.vendor === "Google Inc." || navigator.agent === "Edg/",
        ...
        w = { hasImageCodecs: E(), hasChromiumBreakIterators: L(), supportsWasmGC: W(), crossOriginIsolated: window.crossOriginIsolated };
    function l(...n) {
        return new URL(C(...n), document.baseURI).toString();
    }
    function C(...n) {
        return n
            .filter((t) => !!t)
    ...
    var v = class {
        ...
        async loadEntrypoint(t) {
            let { entrypointUrl: i = l("main.dart.js"), onEntrypointLoaded: r, nonce: e } = t || {};
        ...
        didCreateEngineInitializer(t) {
            typeof this._didCreateEngineInitializerResolve == "function" && (this._didCreateEngineInitializerResolve(t), (this._didCreateEngineInitializerResolve = null), delete _flutter.loader.didCreateEngineInitializer),
        ...
        async _loadWasmEntrypoint(t, i, r, e) {
            if (!this._scriptLoaded) {
                ...
                let { mainWasmPath: a, jsSupportRuntimePath: s } = t,
                    o = l(r, a),
                    c = l(r, s);
                ...
                t.renderer === "skwasm"
                    ? (f = (async () => {
                          ...
                          return (window._flutter_skwasmInstance = m), { skwasm: m.wasmExports, skwasmWrapper: m, ffi: { memory: m.wasmMemory } };
                      })())
                    : (f = Promise.resolve({})),
                    await (await (await d).instantiate(await f)).invokeMain();
            }
        }
    ...
    async function I(n, t, i) {
        ...
        let r,
            e = new Promise((a, s) => {
                r = setTimeout(() => {
                    s(new Error(`${i} took more than ${t}ms to resolve. Moving on.`, { cause: I }));
                }, t);
            });
  ...
  Read more: https://developer.mozilla.org/en-US/docs/Web/Security/Secure_Contexts`)),
            ...
            let { serviceWorkerVersion: i, serviceWorkerUrl: r = l(`flutter_service_worker.js?v=${i}`), timeoutMillis: e = 4e3 } = t,
                a = r;
    ...
    var b = (n, t, i, r) => (
        (window.flutterCanvasKitLoaded = (async () => {
            ...
            let c = k(l(s, "canvaskit.wasm")),
                p = await import(o);
            return (window.flutterCanvasKit = await p.default({ instantiateWasm: c })), window.flutterCanvasKit;
        })()),
    ...
    var U = async (n, t, i, r) => {
        ...
        let o = k(l(r, `${e}.wasm`));
        return await (await import(s)).default({ instantiateWasm: o, mainScriptUrlOrBlob: new Blob([`import '${s}'`], { type: "application/javascript" }) });
    };
    var S = class {
        async loadEntrypoint(t) {
            ...
            a.setTrustedTypesPolicy(e.policy),
                await a.loadServiceWorker(i).catch((o) => {
        ...
        async load({ serviceWorkerSettings: t, onEntrypointLoaded: i, nonce: r, config: e } = {}) {
            ...
            let s = (u) => {
              switch (u) {
                case "skwasm":
                    let supportsGC = w.supportsWasmGC;
                    let hasCodecs = w.hasImageCodecs;
                    let hasIterators = w.hasChromiumBreakIterators;
  
                    console.log("Wasm GC                :", supportsGC);
                    console.log("Wasm Codecs (ignored)  :", hasCodecs);
                    console.log("Wasm Iterators         :", hasIterators);
  
                    let isCompatible = hasIterators && /*hasCodecs &&*/ supportsGC;
                    console.log("skwasm compatible:", isCompatible);
                    return isCompatible;
                default:
                    return !0;
            }
            ...
            (d.flutterTT = new g()),
                t &&
                    ((d.serviceWorkerLoader = new y()),
                    d.serviceWorkerLoader.setTrustedTypesPolicy(d.flutterTT.policy),
                    await d.serviceWorkerLoader.loadServiceWorker(t).catch((u) => {
  ...
  _flutter.loader.load({
    serviceWorkerSettings: {
        serviceWorkerVersion: "2730710492",
    },
});
